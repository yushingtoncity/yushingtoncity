...
**Portfolio site: [yushingtoncity.github.io](https://yushingtoncity.github.io)** —
the findings below as an interactive dashboard, every chart rendered from JSON
regenerated by each project's committed pipeline.
